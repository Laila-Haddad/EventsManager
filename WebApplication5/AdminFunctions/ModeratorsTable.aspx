<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminTables.aspx.cs" Inherits="WebApplication5.pages.WebForm6" %>
...
=
              ...
              <div style="width: 50%; align-content: center; margin: auto; margin-top: 38px;">
                        <p class="card-description"> Moderators <code>.table-striped</code>
                    </p>
                     
                     <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="email" DataSourceID="SqlDataSource2" class="table table-striped">
                    <Columns>
