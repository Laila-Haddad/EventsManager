<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="WebApplication5.pages.AdminFunctions.WebForm2" %>
        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
              ...
              <div style="width: 50%; align-content: center; margin: auto; margin-top: 38px;">
                        <p class="card-description"> Reports 
                    </p>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                      ...
                      <asp:Button  runat="server" OnClick="addbtn_Click" Text="Remove" class="btn btn-gradient-primary me-2" />
